var LANG = {
    ...
    E_GAME_NOT_IN_PROGRESS: "The game has not started yet!",
    E_GAME_CANCELLED: "The game has been cancelled!",
    E_GAME_IN_PROGRESS: "The game has already started!",
    E_GAME_ENDED: "The game has already ended!",
    E_NOT_ENOUGH_PRIV: "You do not have access!",
    E_GAME_FULL: "The game is full!",
    E_GAME_NOT_FULL: "The game room is not full!",
    E_PLAYERS_NO_TEAM: "Everyone must join a team before starting the game!",
    E_ALREADY_PLAYING: "Please continue or leave the game you are currently playing!",
    E_NOT_PLAYING: "You are not currently in this game!",
    E_SAME_TEAM: "You are already in this team!",
    E_NOT_ENOUGH_PLAYERS: "You need at least 4 players to start the game!",
    E_NOT_YOUR_TURN: "It's not your team's turn yet!",
    E_TURN_CONFIRMED: "You've already confirmed your turn, please wait for everyone to confirm!",
    E_CLUE_ALREADY_SET: "The clue has already been revealed to the players!",
    E_CLUE_INVALID: "The clue must be exactly one word!",
    E_CLUE_RANGE: "The clue word must have at least 3 characters!",
    E_CLUE_NUM_EXCEED: "The number of cards specified should not exceed 5!",
    E_CLUE_NUM_NAN: "The number of cards specified is not a number!",
    E_CARD_ALREADY_REVEALED: "One of the selected cards has already been revealed!",
